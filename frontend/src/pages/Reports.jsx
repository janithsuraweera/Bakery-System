    ...
    <div className="space-y-6">
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={[
                      { name: 'Cash', value: dailyRevenue?.data?.cashRevenue || 0 },
                      { name: 'Card', value: dailyRevenue?.data?.cardRevenue || 0 }
                    ]}
                    cx="50%"
                    cy="50%"
                    labelLine={false}
      ...
      {reportType === 'products' && salesAnalysis?.data?.productSales && (
        <div className="card">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salesAnalysis.data.productSales.slice(0, 10)}>
                <CartesianGrid strokeDasharray="3 3" />
